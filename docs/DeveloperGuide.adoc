...
This section highlights the implementation consideration of the program.
...
** Pros: Program might be more intuitive for the user.
** Cons: User has no way of skipping such commands if he or she just want to reset the state of the PTMan and not the view.
