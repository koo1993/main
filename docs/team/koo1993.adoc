...
** Documentation:
*** (REMOVE)Did cosmetic tweaks to existing contents of the User Guide: https://github.com[#14]
** Community:
...
*** (REMOVE) Some parts of the history feature I added was adopted by several other class mates (https://github.com[1], https://github.com[2])
** Tools: (remove)
